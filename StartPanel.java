...
public class StartPanel extends JPanel
{
  ...
  private String actorClue;
    ...
    this.actorClue = "Enter the clue for this celebrity. Films will be added separately.";
    ...
    this.filmField = new JTextField("Enter films this celebrity was featured in (if applicable)");
	...
	private boolean validate(String answerText, String clueText)
	{
		...
		boolean validAnswer = controller.validateCelebrity(answerText);
	...
	private void setupLayout()
	{
		...
		panelLayout.putConstraint(SpringLayout.NORTH, addCelebrityButton, 20, SpringLayout.SOUTH, filmField);
    ...
    panelLayout.putConstraint(SpringLayout.WEST, filmField, 0, SpringLayout.WEST, celebrityRadio);
		panelLayout.putConstraint(SpringLayout.SOUTH, filmField, 85, SpringLayout.SOUTH, answerField);
		panelLayout.putConstraint(SpringLayout.EAST, filmField, 0, SpringLayout.EAST, answerField);
    ...
    String films = filmField.getText().trim();
		answerField.setText("");
		clueField.setText("");
    filmField.setText("");
    ...
    if (actorRadio.isSelected())
		{
			type = "Actor";
      controller.addCelebrity(answer, clue, type, films);
		}else{
      controller.addCelebrity(answer,clue,type);
    }
